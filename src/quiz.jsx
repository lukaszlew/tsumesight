  ...
  return (
    <div class="quiz">
      <div class="board-row" ref={boardRowRef}>
        ...
        />
        {finishPopup && <FinishPopup data={finishPopup} onClose={() => setFinishPopup(null)} />}
      </div>
